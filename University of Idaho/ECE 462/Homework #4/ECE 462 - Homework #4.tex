...
This results in the left-hand side being: \(e^{-i\omega_0t}\). The
Fourier transform of this proves the initial equation:
...
\[\mathscr{F}\{\Psi (x)\}=e^{\frac{-\alpha^2(k-k_0)^2}{2}}\]
    ...
    \hypertarget{problem-3.2.1}{%
\section{Problem 3.2.1}\label{problem-3.2.1}}

\[DOS=\sum_{n=1}^{\infty}\delta(E-n^2)\]

    \hypertarget{problem-3.4.1}{%
\section{Problem 3.4.1}\label{problem-3.4.1}}

The particle is transmitted through the barrier in functions of the
eigenstates. We can plainly see there are periodic dips in what energies
are transferred through the dual-potential well.

    \hypertarget{problem-3.4.2}{%
\section{Problem 3.4.2}\label{problem-3.4.2}}

We could instead solve these types of problems by sending in a large
range of input energy states and measuring the output. On the other
hand, we could also send the equivalent of an \emph{impulse} response -
but I am not sure what the quantum equivalent of this would be.
