...
# Source Files
SOURCEFILES=../../../Source/list.c ../../../Source/tasks.c ../../../Source/portable/MPLAB/PIC32MX/port.c ../../../Source/portable/MPLAB/PIC32MX/port_asm.S ../../../Source/portable/MemMang/heap_2.c ../../../Source/queue.c ../LCDlib.c ../SMBus_IR.c ../chipKIT_PRO_MX7.c ../main.c ../trcKernelPort.c ../trcSnapshotRecorder.c ../trcStreamingRecorder.c ../cn_isr_wrapper.S
...
dist/${CND_CONF}/${IMAGE_TYPE}/Project4.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION)  -o dist/${CND_CONF}/${IMAGE_TYPE}/Project4.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION)
