...
// ============ Office ===================
	...
	#define MY_DEFAULT_IP_ADDR_BYTE4        (17ul)
	...
	#define MY_DEFAULT_PRIMARY_DNS_BYTE3	(119ul)
	#define MY_DEFAULT_PRIMARY_DNS_BYTE4	(223ul)

	#define MY_DEFAULT_SECONDARY_DNS_BYTE1	(129ul)
	#define MY_DEFAULT_SECONDARY_DNS_BYTE2	(101ul)
	#define MY_DEFAULT_SECONDARY_DNS_BYTE3	(119ul)
