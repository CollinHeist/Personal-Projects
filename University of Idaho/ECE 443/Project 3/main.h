	...
	#define MAX_NUM_MSGS				5		// Maximum number of full messages that are stored in the EEPROM
                                                // -> also determines the queue sizes
	...
	#define CN_HANDLER_TASK_PRIORITY	1       // Only a button press, can be low priority
