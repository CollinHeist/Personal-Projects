/** 
 * @file 	main.c
 * @brief 	Main program file, performs the primary project functionality.
 * @author	Collin Heist
 **/
...
static unsigned int create_RTOS_objects() {
    ...
    lcd_string_queue = xQueueCreate(1, sizeof(char*));
    if (!lcd_string_queue)
