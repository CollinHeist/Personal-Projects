...
\hypertarget{problem-7.7.1}{%
\subsection{Problem 7.7.1}\label{problem-7.7.1}}
...
values}{Generic function to generate the magnitude and phase of H(j\textbackslash{}omega) values}}\label{generic-function-to-generate-the-magnitude-and-phase-of-hjomega-values}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}27}]:} \PY{k}{def} \PY{n+nf}{magnitude\PYZus{}phase\PYZus{}response}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{n}{omega\PYZus{}range}\PY{p}{,} \PY{n}{omega\PYZus{}step}\PY{o}{=}\PY{l+m+mi}{10}\PY{p}{,} \PY{n}{gain\PYZus{}num}\PY{o}{=}\PY{k+kc}{None}\PY{p}{,} \PY{n}{gain\PYZus{}den}\PY{o}{=}\PY{k+kc}{None}\PY{p}{)}\PY{p}{:}
...
system}\label{generic-function-to-plot-the-responses-of-a-system}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}110}]:} \PY{k}{def} \PY{n+nf}{create\PYZus{}plots}\PY{p}{(}\PY{n}{df}\PY{p}{,} \PY{n}{error}\PY{o}{=}\PY{k+kc}{False}\PY{p}{)}\PY{p}{:}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}244}]:} \PY{k}{def} \PY{n+nf}{compute\PYZus{}phase\PYZus{}lead}\PY{p}{(}\PY{n}{df}\PY{p}{,} \PY{n}{desired\PYZus{}pm}\PY{p}{)}\PY{p}{:}
...
\subsubsection{My Solution}\label{my-solution}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}111}]:} \PY{n}{num} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{400} \PY{o}{*} \PY{l+m+mi}{8}\PY{p}{]}
          \PY{n}{den} \PY{o}{=} \PY{n}{convolve\PYZus{}all}\PY{p}{(}\PY{p}{[}\PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{100}\PY{p}{,} \PY{l+m+mi}{400}\PY{p}{]}\PY{p}{]}\PY{p}{)}
          
          \PY{n}{df}\PY{p}{,} \PY{n}{m}\PY{p}{,} \PY{n}{w} \PY{o}{=} \PY{n}{magnitude\PYZus{}phase\PYZus{}response}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{10} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{2}\PY{p}{]}\PY{p}{,} \PY{l+m+mf}{0.1}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}71}]:} \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mi}{2}\PY{p}{,} \PY{l+m+mf}{0.001}\PY{p}{)}
...
\end{Verbatim}
    ...
    It is now time to design the phase lag network. I'll start with a
network designed as such:

\[G_c(s)=2\cdot\frac{s+3}{s+0.1}\]

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}72}]:} \PY{n}{comp\PYZus{}network\PYZus{}num} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{l+m+mi}{2}\PY{p}{,} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{3}\PY{p}{]}\PY{p}{)}
         \PY{n}{comp\PYZus{}network\PYZus{}den} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mf}{0.1}\PY{p}{]}
...
\end{Verbatim}
    ...
    This seems to satisfy the problem requirements, but let's look at the
steady-state error at one second, just to be sure.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}73}]:} \PY{n}{display}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Time}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+m+mi}{1}\PY{p}{)} \PY{o}{\PYZam{}} \PY{p}{(}\PY{n}{df}\PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Error}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]} \PY{o}{==} \PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Error}\PY{l+s+s2}{\PYZdq{}}\PY{p}{)}\PY{p}{]}\PY{p}{)}
\end{Verbatim}
...
5000   1.0  0.003001  Step  Step - Error  Error
    ...
    As we can see, at 1 second, the step error for this new transfer
function is below 1\%, and is actually 0.3\%.

\hypertarget{problem-7.7.2}{%
\subsection{Problem 7.7.2}\label{problem-7.7.2}}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}232}]:} \PY{n}{num} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{10} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{6}\PY{p}{]}
          \PY{n}{den} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{l+m+mi}{10} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{3}\PY{p}{,} \PY{l+m+mi}{10} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{6}\PY{p}{]}
          
          \PY{n}{df}\PY{p}{,} \PY{n}{phase\PYZus{}margin}\PY{p}{,} \PY{n}{crossover\PYZus{}w} \PY{o}{=} \PY{n}{magnitude\PYZus{}phase\PYZus{}response}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{10} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{4}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{)}
...
Crossover at 1101.540 (rad/s) has a phase-margin of -100.964 degrees
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}233}]:} \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mf}{0.05}\PY{p}{,} \PY{l+m+mf}{0.0001}\PY{p}{)}
          \PY{n}{df} \PY{o}{=} \PY{n}{response\PYZus{}to\PYZus{}inputs}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{p}{[}\PY{n}{step}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Step}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{t}\PY{p}{)}
          \PY{n}{create\PYZus{}plots}\PY{p}{(}\PY{n}{df}\PY{p}{,} \PY{k+kc}{True}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
    ...
    For starters, I will add a generic gain of 50 to reduce the error
towards 1\%.

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}234}]:} \PY{n}{comp\PYZus{}network\PYZus{}num} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{50}\PY{p}{]}
          \PY{n}{comp\PYZus{}network\PYZus{}den} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{]}
           
          \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mf}{0.05}\PY{p}{,} \PY{l+m+mf}{0.0001}\PY{p}{)}
          \PY{n}{df} \PY{o}{=} \PY{n}{response\PYZus{}to\PYZus{}inputs}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{p}{[}\PY{n}{step}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Step}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{comp\PYZus{}network\PYZus{}num}\PY{p}{,} \PY{n}{comp\PYZus{}network\PYZus{}den}\PY{p}{)}
          \PY{n}{create\PYZus{}plots}\PY{p}{(}\PY{n}{df}\PY{p}{,} \PY{k+kc}{True}\PY{p}{)}\PY{p}{;}
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}235}]:} \PY{n}{df}\PY{p}{,} \PY{n}{phase\PYZus{}margin}\PY{p}{,} \PY{n}{crossover\PYZus{}w} \PY{o}{=} \PY{n}{magnitude\PYZus{}phase\PYZus{}response}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{p}{[}\PY{l+m+mf}{0.1}\PY{p}{,} \PY{l+m+mi}{10} \PY{o}{*}\PY{o}{*} \PY{l+m+mi}{5}\PY{p}{]}\PY{p}{,} \PY{l+m+mi}{1}\PY{p}{,} \PY{n}{comp\PYZus{}network\PYZus{}num}\PY{p}{,} \PY{n}{comp\PYZus{}network\PYZus{}den}\PY{p}{)}
          \PY{n+nb}{print} \PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Crossover at }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{ (rad/s) has a phase\PYZhy{}margin of }\PY{l+s+si}{\PYZob{}:.3f\PYZcb{}}\PY{l+s+s2}{ degrees}\PY{l+s+s2}{\PYZdq{}}\PY{o}{.}\PY{n}{format}\PY{p}{(}\PY{n}{crossover\PYZus{}w}\PY{p}{,} \PY{n}{phase\PYZus{}margin}\PY{p}{)}\PY{p}{)}
          \PY{n}{g} \PY{o}{=} \PY{n}{create\PYZus{}plots}\PY{p}{(}\PY{n}{df}\PY{p}{)}
          \PY{k}{for} \PY{n}{ax} \PY{o+ow}{in} \PY{n}{g}\PY{o}{.}\PY{n}{axes}\PY{o}{.}\PY{n}{flatten}\PY{p}{(}\PY{p}{)}\PY{p}{:}
              \PY{n}{ax}\PY{o}{.}\PY{n}{tick\PYZus{}params}\PY{p}{(}\PY{n}{labelbottom}\PY{o}{=}\PY{k+kc}{True}\PY{p}{)}
...
Crossover at 6712.237 (rad/s) has a phase-margin of 8.663 degrees
    ...
    However, this clearly introduced a lot more sinusoidal overshoot than
desired. To address this, I will increase the phase margin using a phase
lead network, as follows:

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}245}]:} \PY{n}{w\PYZus{}z}\PY{p}{,} \PY{n}{w\PYZus{}p} \PY{o}{=} \PY{n}{compute\PYZus{}phase\PYZus{}lead}\PY{p}{(}\PY{n}{df}\PY{p}{,} \PY{l+m+mi}{55} \PY{o}{\PYZhy{}} \PY{l+m+mi}{9}\PY{p}{)}
          \PY{n+nb}{print} \PY{p}{(}\PY{n}{w\PYZus{}z}\PY{p}{,} \PY{n}{w\PYZus{}p}\PY{p}{)}
\end{Verbatim}
...
-3.180602276292162 -19.484544261264286
    ...
    13602 radians per second, according to the chart. Thus
\(\omega _m = 13602\)

\[\omega _p = 50205.94, \omega _z = 3685.11 \]

\[G_c(s)=50 \cdot \frac{50205.94}{3685.11}\cdot \frac{s+3685.11}{s+50205.94}\]

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}275}]:} \PY{n}{comp\PYZus{}network\PYZus{}num} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{multiply}\PY{p}{(}\PY{l+m+mf}{2.4} \PY{p}{,} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{w\PYZus{}z}\PY{p}{]}\PY{p}{)}
          \PY{n}{comp\PYZus{}network\PYZus{}den} \PY{o}{=} \PY{p}{[}\PY{l+m+mi}{1}\PY{p}{,} \PY{n}{w\PYZus{}p}\PY{p}{]}
           
          \PY{n}{t} \PY{o}{=} \PY{n}{np}\PY{o}{.}\PY{n}{arange}\PY{p}{(}\PY{l+m+mi}{0}\PY{p}{,} \PY{l+m+mf}{0.05}\PY{p}{,} \PY{l+m+mf}{0.0001}\PY{p}{)}
          \PY{n}{df2} \PY{o}{=} \PY{n}{response\PYZus{}to\PYZus{}inputs}\PY{p}{(}\PY{n}{num}\PY{p}{,} \PY{n}{den}\PY{p}{,} \PY{p}{[}\PY{n}{step}\PY{p}{]}\PY{p}{,} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Step}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}\PY{p}{,} \PY{n}{t}\PY{p}{,} \PY{n}{comp\PYZus{}network\PYZus{}num}\PY{p}{,} \PY{n}{comp\PYZus{}network\PYZus{}den}\PY{p}{)}
