...
HD_PWD='U:/ECE 440/Project_5/Project_5.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hardware_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hardware_wrapper.tcl -notrace
