...
#
# Generated by export_simulation on Sun Mar 22 16:04:10 -0700 2020
#
################################################################################
...
switch to the './gene_memory.sh' script.

./gene_memory.sh -reset_run
...
./gene_memory.sh -noclean_files

For more information on the script, please type './gene_memory.sh -help'.
