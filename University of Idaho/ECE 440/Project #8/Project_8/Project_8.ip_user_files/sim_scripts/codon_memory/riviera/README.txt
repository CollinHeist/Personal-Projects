...
#
# Generated by export_simulation on Sun Mar 22 14:53:43 -0700 2020
#
################################################################################
...
switch to the './codon_memory.sh' script.

./codon_memory.sh -reset_run
...
./codon_memory.sh -noclean_files

For more information on the script, please type './codon_memory.sh -help'.
