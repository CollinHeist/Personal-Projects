...
HD_PWD='C:/Users/heis0741/OneDrive - University of Idaho/U-Drive/ECE 440/Project_8/Project_8.runs/gene_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gene_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gene_memory.tcl
