...
HD_PWD='C:/Users/heis0741/OneDrive - University of Idaho/U-Drive/ECE 440/Project_8/Project_8.runs/codon_memory_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log codon_memory.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source codon_memory.tcl
