...
set rc [catch {
  ...
  set_property webtalk.parent_dir {U:/ECE 440/Project_3/Project_3.cache/wt} [current_project]
  set_property parent.project_path {U:/ECE 440/Project_3/Project_3.xpr} [current_project]
  set_property ip_output_repo {{U:/ECE 440/Project_3/Project_3.cache/ip}} [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet {{U:/ECE 440/Project_3/Project_3.runs/synth_1/wrapper.dcp}}
  read_xdc {{U:/ECE 440/Project_3/Project_3.srcs/constrs_1/new/ZYBO_master.xdc}}
...
set rc [catch {
  ...
  write_bitstream -force -no_partial_bitfile wrapper.bit 
